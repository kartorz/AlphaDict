...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CapWordDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 67, 12)
    ...
    "CapWordDialog\0on_saveToolButton_clicked\0"
    "\0on_dictToolButton_clicked\0on_autoClose"
};
...
void CapWordDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_saveToolButton_clicked(); break;
        case 1: _t->on_dictToolButton_clicked(); break;
        case 2: _t->on_autoClose(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CapWordDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CapWordDialog.data,
      qt_meta_data_CapWordDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CapWordDialog.stringdata))
        return static_cast<void*>(const_cast< CapWordDialog*>(this));
